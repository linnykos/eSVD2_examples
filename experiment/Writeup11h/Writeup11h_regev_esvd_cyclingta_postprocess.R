...
load("../../../../out/Writeup11h/Writeup11h_regev_esvd_cyclingta_inflamed.RData")
eSVD_obj_inflamed <- eSVD_obj
load("../../../../out/Writeup11h/Writeup11h_regev_esvd_cyclingta_noninflamed.RData")
...
other_de_genes <- sheet3[sheet3$ident == "Cycling TA","gene"]
...
png(paste0("../../../../out/fig/Writeup11h/Writeup11h_regev_cyclingta_inflamed_diagnostic_gene.png"),
...
png(paste0("../../../../out/fig/Writeup11h/Writeup11h_regev_cyclingta_noninflamed_diagnostic_gene.png"),
    height = 2500, width = 2500,
    units = "px", res = 300)
par(mfrow = c(2,2), mar = c(4,4,4,0.5))
...
png(paste0("../../../../out/fig/Writeup11h/Writeup11h_regev_cyclingta_inflamed_diagnostic_gene_histogram.png"),
...
break_vec <- seq(-max_val-0.15, max_val+0.15, by = 0.1)
png(paste0("../../../../out/fig/Writeup11h/Writeup11h_regev_cyclingta_noninflamed_diagnostic_gene_histogram.png"),
    height = 2000, width = 2500,
    units = "px", res = 300)
par(mfrow = c(2,2))
eSVD2:::gene_plot(eSVD_obj_noninflamed,
...
png(paste0("../../../../out/fig/Writeup11h/Writeup11h_regev_cyclingta_agreement_teststatistic.png"),
