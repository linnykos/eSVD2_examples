...
covariate_df[,"individual"] <- factor(covariate_df[,"individual"], levels = c("1823", setdiff(unique(covariate_df[,"individual"]), "1823")))
covariate_df[,"region"] <- factor(covariate_df[,"region"], levels = c("ACC", "PFC"))
...
covariate_df[,"Seqbatch"] <- factor(covariate_df[,"Seqbatch"], levels = c("SB3", "SB1", "SB2"))
covariate_df[,"Capbatch"] <- factor(covariate_df[,"Capbatch"], levels = c("CB8", setdiff(unique(covariate_df[,"Capbatch"]), "CB8")))
...
save(date_of_run, session_info, sns,
     ...
     file = "../../../../out/Writeup11f/Writeup11f_sns_invip_esvd10.RData")
