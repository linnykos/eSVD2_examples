...
eSVD_obj <- eSVD2:::.reparameterization_esvd_covariates(
  eSVD_obj = eSVD_obj,
  fit_name = "fit_Init",
  omitted_variables = c("Log_UMI", "diagnosis_ASD", omitted_variables)
)
...
eSVD_obj <- eSVD2:::.reparameterization_esvd_covariates(
  eSVD_obj = eSVD_obj,
  fit_name = "fit_Second",
  omitted_variables = c("diagnosis_ASD", omitted_variables)
)
...
save(date_of_run, session_info, sns,
     ...
     file = "../../../../out/Writeup12/Writeup12_sns_layer23_esvd.RData")
