...
load("../../../../out/writeup7/writeup7_sns_esvd_covariates.RData")
...
ggplot2::ggsave(filename = "../../../../out/fig/writeup7/sns_esvd_covariates_full_poisson_umap.png",
...
plot1 <- Seurat::DimPlot(sns, reduction = "esvdfactorumap", group.by = "celltype", label = TRUE,
                         repel = TRUE, label.size = 2.5, raster = F) + Seurat::NoLegend()
plot1 <- plot1 + ggplot2::ggtitle("Human brain (SNS, with covariates)\neSVD, Factor, Poisson")
ggplot2::ggsave(filename = "../../../../out/fig/writeup7/sns_esvd_covariates_factor_poisson_umap.png",
                plot1, device = "png", width = 5, height = 5, units = "in")

###################

png("../../../../out/fig/writeup7/sns_esvd_covariates_asd_hist.png",
