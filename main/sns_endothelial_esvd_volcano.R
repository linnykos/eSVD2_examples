...
load("../../../out/main/sns_endothelial_esvd.RData")
...
tmp <- tmp[which(tmp[,"Cell type"] == "Endothelial"),]
...
png("../../../out/fig/main/sns_endothelial_volcano.png",
...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/sns_endothelial_volcano_ggrepel.png"),
...
write_genes(selected_genes, file = "../../../out/main/sns_endothelial_esvd_de-genes.csv")
