...
covariates <- eSVD2:::format_covariates(dat = mat,
                                        ...
                                        mixed_effect_variables = c("Sample_Name"))

#####################
mixed_effect_variables <- colnames(covariates)[grep("^Sample_Name", colnames(covariates))]
...
esvd_init <- eSVD2:::initialize_esvd(dat = mat,
                                     ...
                                     verbose = 2,
                                     tmp_path = "../../../../out/Writeup11b/Writeup11b_habermann_epithelial_esvd2_tmp.RData")
time_end1 <- Sys.time()

save(date_of_run, session_info, habermann, covariate_df,
     esvd_init, time_start1, time_end1,
     file = "../../../../out/Writeup11b/Writeup11b_habermann_epithelial_esvd2.RData")
