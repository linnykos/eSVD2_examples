...
# from https://bioinformatics.stackexchange.com/questions/5229/converting-gene-symbol-to-ensembl-id-in-r/5230
...
# length(which(summary_name_mat2[,1] != summary_name_mat2[,2]))
# summary_name_mat2[which(summary_name_mat2[,1] != summary_name_mat2[,2]),]
# head(summary_name_mat2)
# summary_name_mat2[duplicated(summary_name_mat2[,1]),]

# summary_name_mat[is.na(summary_name_mat[,1]),]
