...
tmp <- tmp[which(tmp[,"Cell type"] == "AST-PP"),]
...
png("../../../out/fig/main/sns_astpp_volcano.png",
...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/sns_astpp_volcano_ggrepel.png"),
...
write_genes(selected_genes, file = "../../../out/main/sns_astpp_esvd_de-genes.csv")
