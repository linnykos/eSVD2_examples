...
init_res <- eSVD2::initialize_esvd(mat_subset,
                                   k = K,
                                   family = "poisson",
                                   covariates = covariates[,c("Intercept", "Log_UMI")],
...
esvd_res <- eSVD2::opt_esvd(init_res$x_mat,
                            ...
                            verbose = 1)
time_end2 <- Sys.time()
save.image("../../../../out/writeup8e/writeup8e_sns_layer23_esvd_extended_intermediary.RData")
...
esvd_res_nb1 <- eSVD2::opt_esvd(init_x_mat,
                                ...
                                verbose = 1)
time_end3 <- Sys.time()
save.image("../../../../out/writeup8e/writeup8e_sns_layer23_esvd_extended.RData")
