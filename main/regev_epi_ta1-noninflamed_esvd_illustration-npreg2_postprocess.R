...
load("../../../out/main/regevEpi_ta1-noninflamed_esvd_illustration-npreg2.RData")
...
curve_list <- lapply(1:6, function(k){
  ...
  quantile_mat <- t(sapply(1:n, function(i){
    stats::quantile(lognorm_npreg_list[i,idx], probs = c(0.25, .5, 0.75))
  }))
...
png("../../../out/fig/main/regevEpi_ta1-noninflamed_npreg-lognorm.png",
