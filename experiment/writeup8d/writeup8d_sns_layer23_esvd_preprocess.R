...
ls_vec <- ls()
ls_vec <- ls_vec[!ls_vec %in% c("covariates", "mat", "de_genes", "sns", "date_of_run", "session_info")]
rm(list = ls_vec)
save.image("../../../../out/writeup8d/writeup8d_sns_layer23_processed.RData")
save(mat, covariates, de_genes, date_of_run, session_info,
     file = "../../../../out/writeup8d/writeup8d_sns_layer23_processed_onlymat.RData")
