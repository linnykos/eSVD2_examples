...
load("../../../../out/Writeup13/regevEpi_ta2-inflamed_esvd.RData")
regevEpi_inflamed <- regevEpi
eSVD_obj_inflamed <- eSVD_obj
load("../../../../out/Writeup13/regevEpi_ta2-noninflamed_esvd.RData")
...
png("../../../../out/fig/Writeup13/regevEpi_ta2-inflamed_volcano.png",
...
png("../../../../out/fig/Writeup13/regevEpi_ta2-inflamed_volcano-stats.png",
    height = 2500, width = 2500,
    units = "px", res = 500)
...
png("../../../../out/fig/Writeup13/regevEpi_ta2-noninflamed_volcano.png",
    height = 2500, width = 2500,
    units = "px", res = 500)
par(mar = c(3,3,0.4,0.1))
plot(x = x_vec, y = y_vec,
...
png("../../../../out/fig/Writeup13/regevEpi_ta2-noninflamed_volcano-stats.png",
    height = 2500, width = 2500,
    units = "px", res = 500)
plot(x = 1:10, y = 1:10, type = "n",
     main = paste0("Fisher = ", fisher, "\nTotal: ",
...
png("../../../../out/fig/Writeup13/regevEpi_ta2-agreement_de-genes.png",
...
png("../../../../out/fig/Writeup13/regevEpi_ta2-agreement_hk-genes.png",
    height = 1750, width = 1750,
    units = "px", res = 500)
