...
load("../../../../out/Writeup13/habermann_Macrophage_esvd.RData")
eSVD_obj_habermann <- eSVD_obj

load("../../../../out/Writeup13/adams_Macrophage_esvd.RData")
...
adams_df_genes_others <- unique(df_mat$gene[which(df_mat$cellType %in% c("B", "T", "Macrophage Alveolar", "NK"))])
df_mat <- read.csv("~/project/eSVD/data/GSE135893_habermann_lung/Table_S4_DEG_analysis/Disease_vs_Control/Macrophages_disease_vs_control_.csv",
                   sep = ",")
habermann_df_genes <- df_mat$X
file_vec <- c("T_Cells_disease_vs_control_.csv", "Monocytes_disease_vs_control_.csv",
...
png("../../../../out/fig/Writeup13/adams_habermann_Macrophage_esvd-agreement_de-genes.png",
...
png("../../../../out/fig/Writeup13/adams_habermann_Macrophage_esvd-agreement_hk-genes.png",
    height = 1750, width = 1750,
    units = "px", res = 500)
