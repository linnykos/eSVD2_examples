...
load("../../../out/main/regevImm_plasma_preprocessed.RData")
...
keep_vec[which(regevImm$Sample_Health == "Non-inflamed")] <- 0
...
save(date_of_run, session_info, regevImm,
     ...
     file = "../../../out/main/regevImm_plasma-inflamed_esvd.RData")
