...
save(before_npreg_list, lib_vec,
     ...
     file = "../../../out/main/adams_T_esvd_illustration-npreg.RData")

nat_mat1 <- tcrossprod(eSVD_obj$fit_Second$x_mat, eSVD_obj$fit_Second$y_mat)
nat_mat2 <- tcrossprod(eSVD_obj$covariates[,"Disease_Identity_IPF"], eSVD_obj$fit_Second$z_mat[,"Disease_Identity_IPF"])
