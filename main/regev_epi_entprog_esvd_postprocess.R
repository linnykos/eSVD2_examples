...
other_de_genes <- sheet3[sheet3$ident == "Enterocyte ProgenitorsA","gene"]
...
png(paste0("../../../out/fig/main/regev_entprog_inflamed_gene_histogram.png"),
...
break_vec <- seq(-max_val-0.15, max_val+0.15, by = 0.1)
png(paste0("../../../out/fig/main/regev_entprog_noninflamed_gene_histogram.png"),
    height = 2000, width = 3500,
    units = "px", res = 300)
par(mfrow = c(2,3))
...
png(paste0("../../../out/fig/main/regev_entprog_agreement.png"),
...
plot(x = eSVD_obj_noninflamed$teststat_vec,
     ...
     main = "Enterocyte Progenitors", asp = T,
     xlim = xlim, ylim = ylim)
