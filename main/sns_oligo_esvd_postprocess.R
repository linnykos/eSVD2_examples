...
tmp <- tmp[which(tmp[,"Cell type"] == "Oligodendrocytes"),]
...
png("../../../out/fig/main/sns_oligo_esvd_teststat_histogram.png",
...
png("../../../out/fig/main/sns_oligo_esvd_teststat_histogram_separate.png",
