...
nuisance_safe <- eSVD_obj$fit_Second$nuisance_vec
mean(log10(eSVD_obj$fit_Second$nuisance_vec))

eSVD_obj$fit_Second$nuisance_vec <- 10^(scale(log10(eSVD_obj$fit_Second$nuisance_vec), center = T, scale = F))
...
png("../../../../out/fig/Writeup11i/Writeup11i_sns_layer23_esvd_posterior-pseudocount_teststat_histogram.png",
...
png("../../../../out/fig/Writeup11i/Writeup11i_sns_layer23_esvd_posterior-pseudocount_teststat_histogram_separate.png",
