...
set.seed(10)
library(Seurat)
source("../eSVD2_examples/simulation/data_generator3.R")
...
input_obj$nat_mat[,de_idx] <- input_obj$nat_mat[,de_idx]*2
...
save(seurat_obj,
     ...
     file = "../eSVD2_examples/simulation/simulation_3.RData")
