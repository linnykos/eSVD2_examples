...
load("../../../out/main/sns_layer56_esvd.RData")
...
tmp <- tmp[which(tmp[,"Cell type"] == "L5/6"),]
...
png("../../../out/fig/main/sns_layer56_volcano.png",
...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/sns_layer56_volcano_ggrepel.png"),
...
write_genes(selected_genes, file = "../../../out/main/sns_layer56_esvd_de-genes.csv")
