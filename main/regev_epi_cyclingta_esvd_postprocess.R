...
png(paste0("../../../out/fig/main/regev_cyclingta_inflamed_gene_histogram.png"),
...
break_vec <- seq(-max_val-0.15, max_val+0.15, by = 0.1)
png(paste0("../../../out/fig/main/regev_cyclingta_noninflamed_gene_histogram.png"),
    height = 2000, width = 3500,
    units = "px", res = 300)
par(mfrow = c(2,3))
...
png(paste0("../../../out/fig/main/regev_cyclingta_agreement.png"),
