...
load("../eSVD2_examples/simulation/simulation_null_1.RData")
...
covariate_dat <- seurat_obj@meta.data[,c("CC", "Sex", "Individual")]
...
eSVD_obj <- eSVD2:::initialize_esvd(dat = mat,
                                    covariates = covariate[,c("Intercept", "CC", "Log_UMI", "Sex")],
