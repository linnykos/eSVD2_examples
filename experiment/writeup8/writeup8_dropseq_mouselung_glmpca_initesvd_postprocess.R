...
load("../../../../out/writeup8/writeup8_dropseq_mouselung_esvd_glmpca_initesvd.RData")
...
ggplot2::ggsave(filename = "../../../../out/fig/writeup8/dropseq_mouselung_glmpca_initesvd_factor_esvd.png",
...
ggplot2::ggsave(filename = "../../../../out/fig/writeup8/dropseq_mouselung_glmpca_initesvd_factor_glmpca.png",
                plot1, device = "png", width = 6, height = 5, units = "in")
