rm(list=ls())
load( "../../../../out/Writeup11b/Writeup11b_habermann_epithelial_esvd.RData")
library(Seurat)
library(eSVD2)
set.seed(10)
...
png("../../../../out/fig/Writeup11b/habermann_epithelial_esvd_teststat_histogram.png", height = 1200, width = 1200,
    units = "px", res = 300)
...
png("../../../../out/fig/Writeup11b/habermann_epithelial_esvd_teststat_histogram_separate.png",
