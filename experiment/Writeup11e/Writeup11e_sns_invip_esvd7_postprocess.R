...
load("../../../../out/Writeup11e/Writeup11e_sns_invip_esvd7.RData")
...
png("../../../../out/fig/Writeup11e/Writeup11e_sns_invip_esvd7_teststat_histogram.png", height = 1200, width = 1200,
    units = "px", res = 300)
...
png("../../../../out/fig/Writeup11e/Writeup11e_sns_invip_esvd7_teststat_histogram_separate.png",
