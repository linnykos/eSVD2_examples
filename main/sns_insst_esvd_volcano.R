...
load("../../../out/main/sns_insst_esvd.RData")
...
tmp <- tmp[which(tmp[,"Cell type"] == "IN-SST"),]
...
png("../../../out/fig/main/sns_insst_volcano.png",
...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/sns_insst_volcano_ggrepel.png"),
...
write_genes(selected_genes, file = "../../../out/main/sns_insst_esvd_de-genes.csv")
