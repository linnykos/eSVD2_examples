...
load("../../../../out/Writeup13/adams_T_esvd.RData")
...
png("../../../../out/fig/Writeup13/adams_habermann_T_esvd-agreement_de-genes.png",
...
png("../../../../out/fig/Writeup13/adams_habermann_T_esvd-agreement_hk-genes.png",
    height = 1750, width = 1750,
    units = "px", res = 500)
