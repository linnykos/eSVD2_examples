rm(list=ls())
library(Seurat)
load("../../../../out/Writeup10/Writeup10_sns_invip_esvd2_resample.RData")
...
png("../../../../out/fig/Writeup10/sns_invip_esvd2_resample_teststat_histogram.png", height = 1200, width = 1200,
    units = "px", res = 300)
...
png("../../../../out/fig/Writeup10/sns_invip_esvd2_resample_teststat_histogram_separate.png",
...
break_vec <- seq(-max_val-0.05, max_val+0.05, by = 0.1)
break_vec[1] <- -max_val-0.05; break_vec[length(break_vec)] <- max_val+0.05
png("../../../../out/fig/Writeup10/sns_invip_esvd2_resample_teststat_histogram_logconcave.png", height = 1200, width = 1200,
    units = "px", res = 300)
hist(teststat_vec, breaks = break_vec,
     xlim = c(-max_val, max_val),
