...
png(paste0("../../../../out/fig/Writeup11d/Writeup11d_adams_T_gene.png"),
...
for(k in 1:length(cycling_idx_subset)){
  ...
  png(paste0("../../../../out/fig/Writeup11d/Writeup11d_adams_T_cell-cycling-",
             gene_names[idx], ".png"),
      height = 2500, width = 2500,
      units = "px", res = 300)
  par(mfrow = c(2,2), mar = c(4,4,4,0.5))
...
for(k in 1:length(de_idx_subset)){
  ...
  png(paste0("../../../../out/fig/Writeup11d/Writeup11d_adams_T_cell-de-",
             gene_names[idx], ".png"),
      height = 2500, width = 2500,
      units = "px", res = 300)
  par(mfrow = c(2,2), mar = c(4,4,4,0.5))
