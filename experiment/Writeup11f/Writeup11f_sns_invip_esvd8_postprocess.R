...
png("../../../../out/fig/Writeup11f/Writeup11f_sns_invip_esvd8_teststat_histogram.png",
...
png("../../../../out/fig/Writeup11f/Writeup11f_sns_invip_esvd8_teststat_histogram_separate.png",
