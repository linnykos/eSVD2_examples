rm(list=ls())
load("../../../../out/Writeup11h/Writeup11h_regevEpi_cyclingta_processed.RData")
...
# table(covariate_dat$Sample, covariate_dat$Subject_Disease)
# table(covariate_dat$Sample, covariate_dat$Subject_Smoking)
...
save(date_of_run, session_info, regevEpi,
     ...
     file = "../../../../out/Writeup11h/Writeup11h_regev_esvd_cyclingta_noninflamed.RData")
