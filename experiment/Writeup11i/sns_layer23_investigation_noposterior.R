...
eSVD_obj$fit_Second$posterior_mean_mat <- exp(nat_mat1 + nat_mat2)
round(quantile(eSVD_obj$fit_Second$posterior_mean_mat), 2)

eSVD_obj$fit_Second$posterior_var_mat <- sweep(eSVD_obj$fit_Second$posterior_mean_mat,
                                               MARGIN = 2,
                                               STATS = eSVD_obj$fit_Second$nuisance_vec,
                                               FUN = '/')
round(quantile(eSVD_obj$fit_Second$posterior_var_mat),2)
...
png("../../../../out/fig/Writeup11i/Writeup11i_sns_layer23_esvd_teststat_histogram.png",
...
png("../../../../out/fig/Writeup11i/Writeup11i_sns_layer23_esvd_teststat_histogram_separate.png",
