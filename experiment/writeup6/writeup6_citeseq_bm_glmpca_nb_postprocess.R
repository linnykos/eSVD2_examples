...
ggplot2::ggsave(filename = "../../../../out/fig/writeup6/citeseq_bm_glmpca_full_nb_umap.png",
...
plot1 <- Seurat::DimPlot(bm, reduction = "glmfactorumap", group.by = "celltype.l2", label = TRUE,
                         repel = TRUE, label.size = 2.5) + Seurat::NoLegend()
plot1 <- plot1 + ggplot2::ggtitle("Human bone marrow (CITE-seq)\nGLM-PCA, Factor, NB")
ggplot2::ggsave(filename = "../../../../out/fig/writeup6/citeseq_bm_glmpca_factor_nb_umap.png",
                plot1, device = "png", width = 5, height = 5, units = "in")
...
png("../../../../out/fig/writeup6/citeseq_bm_glmpca_nb_score.png", height = 1500,
