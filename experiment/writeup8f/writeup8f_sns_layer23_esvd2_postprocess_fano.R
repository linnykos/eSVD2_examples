rm(list=ls())
load("../../../../out/writeup8f/writeup8f_sns_layer23_esvd2.RData")
...
png("../../../../out/fig/writeup8f/sns_layer23_esvd2_volcano.png", height = 1200, width = 1200,
    units = "px", res = 300)
...
png("../../../../out/fig/writeup8f/sns_layer23_esvd2_zscore_histogram.png", height = 1200, width = 1200,
    units = "px", res = 300)
...
filename_vec <- c("truede", "nonde", "smallestp", "largestx",
                  "smallestzero", "0.9zero", "0.2zero")

for(kk in 1:length(gene_indices)){
  idx <- gene_indices[kk]
  png(paste0("../../../../out/fig/writeup8f/sns_layer23_esvd2_gene_", filename_vec[kk], ".png"),
