...
set.seed(10)
library(Seurat)
source("../eSVD2_examples/simulation/data_generator5.R")
...
quantile(input_obj$obs_mat, probs = c(0,.25,.5,.75,.9,.95,1))
...
save(seurat_obj,
     ...
     file = "../eSVD2_examples/simulation/simulation_5.RData")
