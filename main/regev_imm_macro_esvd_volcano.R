...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/regevImm_macro-inflamed_volcano_ggrepel.png"),
...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/regevImm_macro-noninflamed_volcano_ggrepel.png"),
                plot1, device = "png", width = 5*.75, height = 7*.75, units = "in")
