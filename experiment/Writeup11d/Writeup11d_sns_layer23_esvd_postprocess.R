...
load("../../../../out/Writeup11d/Writeup11d_sns_layer23_esvd.RData")
...
png("../../../../out/fig/Writeup11d/Writeup11d_sns_layer23_esvd_teststat_histogram.png", height = 1200, width = 1200,
    units = "px", res = 300)
...
png("../../../../out/fig/Writeup11d/Writeup11d_sns_layer23_esvd_teststat_histogram_separate.png",
