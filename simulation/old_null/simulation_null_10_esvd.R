...
load("../eSVD2_examples/simulation/simulation_null_10.RData")
...
plot(jitter(1/dispersion_vec), 1/eSVD_obj$fit_Second$nuisance_vec, col = rgb(0.5,0.5,0.5,0.5), pch = 16)
...
save(date_of_run, session_info,
     ...
     y_block_assignment,
     z_mat,
     file = "../eSVD2_examples/simulation/simulation_null_10_esvd.RData")
