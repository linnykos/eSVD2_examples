...
png("../../../out/fig/main/sns_invip_volcano.png",
...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/sns_invip_volcano_ggrepel.png"),
...
write_genes(selected_genes, file = "../../../out/main/sns_invip_esvd_de-genes.csv")
