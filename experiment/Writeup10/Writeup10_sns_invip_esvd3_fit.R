load("../../../../out/Writeup10/Writeup10_sns_invip_esvd3_initialize.RData")
library(Seurat)
set.seed(10)
date_of_run <- Sys.time()
session_info <- devtools::session_info()

diagnosis_idx <- which(colnames(init_res$covariates) == "diagnosis_ASD")
covariates_diag <- init_res$covariates[,diagnosis_idx]
b_init <- init_res$b_mat[,diagnosis_idx]
offset_mat <- tcrossprod(init_res$covariates[,-diagnosis_idx], init_res$b_mat[,-diagnosis_idx])
...
save(date_of_run, session_info,
     ...
     file = "../../../../out/Writeup10/Writeup10_sns_invip_esvd3.RData")
