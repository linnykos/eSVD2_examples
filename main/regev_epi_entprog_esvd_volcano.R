...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/regevEpi_entprog-inflamed_volcano_ggrepel.png"),
...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/regevEpi_entprog-noninflamed_volcano_ggrepel.png"),
                plot1, device = "png", width = 5*.75, height = 7*.75, units = "in")
