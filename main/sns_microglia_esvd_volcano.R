...
load("../../../out/main/sns_microglia_esvd.RData")
...
tmp <- tmp[which(tmp[,"Cell type"] == "Microglia"),]
...
png("../../../out/fig/main/sns_microglia_volcano.png",
...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/sns_microglia_volcano_ggrepel.png"),
...
write_genes(selected_genes, file = "../../../out/main/sns_microglia_esvd_de-genes.csv")
