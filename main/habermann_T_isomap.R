...
set.seed(10)
pca_mat <- scale(habermann[["pca"]]@cell.embeddings[,1:30])
...
df <- data.frame(pred =  factor(habermann$Gender)); df <- cbind(df, habermann[["pca"]]@cell.embeddings[,1:30])
...
df <- data.frame(pred =  factor(habermann$Tobacco)); df <- cbind(df, habermann[["pca"]]@cell.embeddings[,1:30])
fitted_model <- stats::glm(pred ~ ., data = df, family = binomial)
null_model <- stats::glm(pred ~ 1, data = df, family = binomial)
deviance_current <- stats::deviance(fitted_model)
deviance_null <- stats::deviance(null_model)
...
df <- data.frame(pred =  factor(habermann$Gender)); df <- cbind(df, eSVD_obj$fit_Second$x_mat[,1:30])
fitted_model <- stats::glm(pred ~ ., data = df, family = binomial)
null_model <- stats::glm(pred ~ 1, data = df, family = binomial)
deviance_current <- stats::deviance(fitted_model)
deviance_null <- stats::deviance(null_model)
...
df <- data.frame(pred =  factor(habermann$Tobacco)); df <- cbind(df, eSVD_obj$fit_Second$x_mat[,1:30])
fitted_model <- stats::glm(pred ~ ., data = df, family = binomial)
null_model <- stats::glm(pred ~ 1, data = df, family = binomial)
deviance_current <- stats::deviance(fitted_model)
deviance_null <- stats::deviance(null_model)
