...
load("../../../out/main/sns_opc_esvd.RData")
...
tmp <- tmp[which(tmp[,"Cell type"] == "OPC"),]
...
png("../../../out/fig/main/sns_opc_volcano.png",
...
ggplot2::ggsave(filename = paste0("../../../out/fig/main/sns_opc_volcano_ggrepel.png"),
...
write_genes(selected_genes, file = "../../../out/main/sns_opc_esvd_de-genes.csv")
