...
load("../../../out/main/regevEpi_ta1-noninflamed_esvd_illustration-npreg.RData")
...
png("../../../out/fig/main/regevEpi_ta1-noninflamed_npreg-before.png",
...
png("../../../out/fig/main/regevEpi_ta1-noninflamed_npreg-after.png",
    height = 2250, width = 1100,
    units = "px", res = 500)
par(mfrow = c(3,2), mar = c(3,3,3,1))
xlim <- range(library_breaks)
