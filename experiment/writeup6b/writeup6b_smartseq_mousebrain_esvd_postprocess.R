rm(list=ls())
load("../../../../out/writeup6b/writeup6b_smartseq_mousebrain_esvd.RData")
...
ggplot2::ggsave(filename = "../../../../out/fig/writeup6b/smartseq_mousebrain_esvd_full_poisson_umap.png",
...
plot1 <- Seurat::DimPlot(brain, reduction = "esvdfactorumap", group.by = "subclass", label = TRUE,
                         repel = TRUE, label.size = 2.5) + Seurat::NoLegend()
plot1 <- plot1 + ggplot2::ggtitle("Mouse Brain (Smartseq)\neSVD, Factor, Poisson")
ggplot2::ggsave(filename = "../../../../out/fig/writeup6b/smartseq_mousebrain_esvd_factor_poisson_umap.png",
                plot1, device = "png", width = 5, height = 5, units = "in")

#########################

png( "../../../../out/fig/writeup6b/smartseq_mousebrain_esvd_poisson_libraryhist.png",
