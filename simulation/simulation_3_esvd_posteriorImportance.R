...
load("../eSVD2_examples/simulation/simulation_3.RData")
load("../eSVD2_examples/simulation/simulation_3_esvd.RData")
...
png("../../out/fig/simulation/simulation_3_raw-density.png",
...
png("../../out/fig/simulation/simulation_3_posterior-density.png",
    height = 250, width = 1250,
    units = "px", res = 500)
par(mar = c(0.1,0.1,0.1,0.1))
...
png("../../out/fig/simulation/simulation_3_teststatistic_scatterplot.png",
