...
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/fig/main/habermann_T_original-isomap_by-gender.png"),
                plot1, device = "png", width = 4, height = 4, units = "in",
                dpi = 300)
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("R2: ", round(r2,2)))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/fig/main/habermann_T_original-isomap-smoking.png"),
                plot1, device = "png", width = 4, height = 4, units = "in",
                dpi = 300)
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("R2: ", round(r2,2)))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/fig/main/habermann_T_esvd-isomap_by-gender.png"),
                plot1, device = "png", width = 4, height = 4, units = "in",
                dpi = 300)
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("R2: ", round(r2,2)))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/fig/main/habermann_T_esvd-isomap_by-smoking.png"),
                plot1, device = "png", width = 4, height = 4, units = "in",
                dpi = 300)
