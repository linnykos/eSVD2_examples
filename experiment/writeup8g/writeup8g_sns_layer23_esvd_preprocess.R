...
ls_vec <- ls_vec[!ls_vec %in% c("covariates", "mat", "de_genes", "sns",
                                "date_of_run", "session_info", "metadata")]
rm(list = ls_vec)
save.image("../../../../out/writeup8f/writeup8g_sns_layer23_processed.RData")
save(mat, covariates, de_genes, date_of_run, session_info, metadata,
     file = "../../../../out/writeup8f/writeup8g_sns_layer23_processed_onlymat.RData")
