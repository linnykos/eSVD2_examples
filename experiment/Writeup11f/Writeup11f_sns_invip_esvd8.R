...
covariate_df[,"individual"] <- factor(covariate_df[,"individual"])
covariate_df[,"region"] <- factor(covariate_df[,"region"])
covariate_df[,"diagnosis"] <- factor(covariate_df[,"diagnosis"], levels = c("Control", "ASD"))
covariate_df[,"sex"] <- factor(covariate_df[,"sex"])
covariate_df[,"Seqbatch"] <- factor(covariate_df[,"Seqbatch"])
covariate_df[,"Capbatch"] <- factor(covariate_df[,"Capbatch"])
covariates <- eSVD2:::format_covariates(dat = mat,
                                        ...
                                        variables_enumerate_all = c("region", "sex", "individual", "Seqbatch", "Capbatch"))
...
save(date_of_run, session_info, sns,
     ...
     file = "../../../../out/Writeup11f/Writeup11f_sns_invip_esvd8.RData")
