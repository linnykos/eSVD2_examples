...
png(paste0("../../../../out/fig/Writeup11d/Writeup11d_sns_layer4_diagnostic_gene.png"),
...
png(paste0("../../../../out/fig/Writeup11d/Writeup11d_sns_layer4_diagnostic_gene2.png"),
    height = 2500, width = 2500,
    units = "px", res = 300)
par(mfrow = c(2,2), mar = c(4,4,4,0.5))
eSVD2:::gene_plot(eSVD_obj,
...
for(k in 1:length(cycling_idx_subset)){
  ...
  png(paste0("../../../../out/fig/Writeup11d/Writeup11d_sns_layer4_diagnostic_cell-cycling-",
             gene_names[idx], ".png"),
      height = 2500, width = 2500,
      units = "px", res = 300)
  par(mfrow = c(2,2), mar = c(4,4,4,0.5))
...
for(k in 1:length(de_idx_subset)){
  ...
  png(paste0("../../../../out/fig/Writeup11d/Writeup11d_sns_layer4_diagnostic_cell-de-",
             gene_names[idx], ".png"),
      height = 2500, width = 2500,
      units = "px", res = 300)
  par(mfrow = c(2,2), mar = c(4,4,4,0.5))
