...
load("../../../../out/Writeup12/regevEpi_ta1-inflamed_esvd.RData")
regevEpi_inflamed <- regevEpi
eSVD_obj_inflamed <- eSVD_obj
load("../../../../out/Writeup12/regevEpi_ta1-noninflamed_esvd.RData")
...
png(paste0("../../../../out/fig/Writeup12/regev_ta1_agreement.png"),
...
png("../../../../out/fig/Writeup12/regevEpi_ta1-inflamed_volcano.png",
...
png("../../../../out/fig/Writeup12/regevEpi_ta1-noninflamed_volcano.png",
    height = 2500, width = 2500,
    units = "px", res = 500)
par(mar = c(3,3,0.4,0.1))
plot(x = x_vec, y = y_vec,
...
png("../../../../out/fig/Writeup12/regevEpi_ta1-agreement_de-genes.png",
...
png("../../../../out/fig/Writeup12/regevEpi_ta1-agreement_hk-genes.png",
    height = 1750, width = 1750,
    units = "px", res = 500)
