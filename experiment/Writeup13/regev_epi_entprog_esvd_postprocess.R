...
filename_celltype <- "Writeup13/regevEpi_entprog"
de_gene_celltype <- "Enterocyte Progenitors"

load(paste0("../../../../out/", filename_celltype, "-inflamed_esvd.RData"))
regevEpi_inflamed <- regevEpi
eSVD_obj_inflamed <- eSVD_obj
load(paste0("../../../../out/", filename_celltype, "-noninflamed_esvd.RData"))
...
noninf_de_genes <- sheet1[sheet1$ident == de_gene_celltype,"gene"]
inf_de_genes <- sheet2[sheet2$ident == de_gene_celltype,"gene"]
other_de_genes <- sheet3[sheet3$ident == de_gene_celltype,"gene"]
...
png(paste0("../../../../out/fig/", filename_celltype, "-inflamed_volcano.png"),
...
png(paste0("../../../../out/fig/", filename_celltype, "-inflamed_volcano-stats.png"),
    height = 2500, width = 2500,
    units = "px", res = 500)
...
png(paste0("../../../../out/fig/", filename_celltype, "-noninflamed_volcano.png"),
    height = 2500, width = 2500,
    units = "px", res = 500)
par(mar = c(3,3,0.4,0.1))
plot(x = x_vec, y = y_vec,
...
png(paste0("../../../../out/fig/", filename_celltype, "-noninflamed_volcano-stats.png"),
    height = 2500, width = 2500,
    units = "px", res = 500)
plot(x = 1:10, y = 1:10, type = "n",
     main = paste0("Fisher = ", fisher, "\nTotal: ",
...
png(paste0("../../../../out/fig/", filename_celltype, "-agreement_de-genes.png"),
...
png(paste0("../../../../out/fig/", filename_celltype, "-agreement_hk-genes.png"),
    height = 1750, width = 1750,
    units = "px", res = 500)
