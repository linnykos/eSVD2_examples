# from https://github.com/linnykos/eSVD2_examples/blob/8c729d9800e3cefbdc2ac1fc61db1f32f599f4fc/main/habermann_T_esvd.R
# using version https://github.com/linnykos/eSVD2/tree/765f6f22860e4753be2b36d33e2243295b23ff24
rm(list=ls())
...
save(date_of_run, session_info, habermann,
     ...
     file = "../../../../out/Writeup13/habermann_T_esvd_old-v057.RData")
