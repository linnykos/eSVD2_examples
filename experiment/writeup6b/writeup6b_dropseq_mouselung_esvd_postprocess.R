rm(list=ls())
load("../../../../out/writeup6b/writeup6b_dropseq_mouselung_esvd.RData")
...
ggplot2::ggsave(filename = "../../../../out/fig/writeup6b/dropseq_mouselung_esvd_full_poisson_umap.png",
...
plot1 <- Seurat::DimPlot(lung, reduction = "esvdfactorumap", group.by = "celltype", label = TRUE,
                         repel = TRUE, label.size = 2.5) + Seurat::NoLegend()
plot1 <- plot1 + ggplot2::ggtitle("Mouse Lung (Dropseq)\neSVD, Factor, Poisson")
ggplot2::ggsave(filename = "../../../../out/fig/writeup6b/dropseq_mouselung_esvd_factor_poisson_umap.png",
                plot1, device = "png", width = 5, height = 5, units = "in")

#########################

png( "../../../../out/fig/writeup6b/dropseq_mouselung_esvd_poisson_libraryhist.png",
