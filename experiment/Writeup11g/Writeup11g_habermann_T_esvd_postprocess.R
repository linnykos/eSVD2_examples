...
png(paste0("../../../../out/fig/Writeup11g/Writeup11g_habermann_T_diagnostic_gene.png"),
...
png(paste0("../../../../out/fig/Writeup11g/Writeup11g_habermann_T_diagnostic_gene_histogram.png"),
