...
sign_vec[which(sns_de$avg_diff > 0)] <- -1 #if the log-fold change is positive, control is larger than case
...
png("../../../../out/fig/writeup8c/sns_layer23_sctransform_hist_zvalues.png",
...
# save(sns_de, file = "../../../../out/writeup8c/sns_layer23_sctransform_de.RData")
# load("../../out/writeup8c/sns_layer23_sctransform_de.RData")

sns_de$avg_diff <- -sns_de$avg_diff
png("../../../../out/fig/writeup8c/sns_layer23_sctransform_volcano.png",
    width = 3000, height = 3000, units = "px", res = 300)
EnhancedVolcano:: EnhancedVolcano(sns_de,
                                  lab = rownames(sns_de),
                                  x = 'avg_diff', # why is it this name? .. Oh, see https://github.com/satijalab/seurat/blob/master/R/differential_expression.R#L781
                                  y = 'p_val',
                                  xlim = c(-1,1),
