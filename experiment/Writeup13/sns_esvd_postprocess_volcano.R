...
celltype_vec <- c("astpp", "endothelial", "insst", "invip",
                  "layer4", "layer23", "layer56", "layer56cc",
                  "microglia", "oligo", "opc")
velmeshev_celltype_vec <- c("AST-PP", "Endothelial", "IN-SST", "IN-VIP",
                            "L4", "L2/3", "L5/6", "L5/6-CC",
...
for(i in 1:length(celltype_vec)){
  celltype <- celltype_vec[i]
  velmeshev_celltype <- velmeshev_celltype_vec[i]

  print(paste0("Analyzing celltype ", velmeshev_celltype))
