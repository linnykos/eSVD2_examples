...
png("../../../../out/fig/Writeup11i/Writeup11i_sns_layer23_esvd_posterior_librarymin_teststat_histogram.png",
...
png("../../../../out/fig/Writeup11i/Writeup11i_sns_layer23_esvd_posterior_librarymin_teststat_histogram_separate.png",
